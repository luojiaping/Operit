...
internal data class ToolPkgMainRegistrationCapture(
    ...
    val inputSlotPlugins: List<String>,
...
internal class JsToolPkgRegistrationSession {
    ...
    fun appendInputSlotPlugin(specJson: String) =
        append(RegistrationBucket.INPUT_SLOT, specJson)
    ...
    fun finish(executionResult: Any?): ToolPkgMainRegistrationCapture {
        ...
        synchronized(lock) {
            ...
            return ToolPkgMainRegistrationCapture(
                ...
                inputSlotPlugins = read(RegistrationBucket.INPUT_SLOT),
    ...
    return """
        (function() {
            ...
            [
                ...
                ['registerInputSlotPlugin', 'registerToolPkgInputSlotPlugin'],
